#!/usr/bin/env python3
"""
Build the browser version of Tour De Force.

Inlines web_curses.py (the in-browser curses shim), tdf.py itself
(untouched), and web_bridge.py (glue) into template.html. Re-run after
changing any of those files:

    python3 -m py_compile tdf.py web_curses.py web_bridge.py
